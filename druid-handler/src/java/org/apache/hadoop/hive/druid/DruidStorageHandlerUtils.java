...
public final class DruidStorageHandlerUtils {
  ...
  /**
   * @param directory  containing the segments descriptor info
  ...
  public static List<DataSegment> getPublishedSegmentsFromDir(Path directory, Configuration conf)
          throws IOException {
    ImmutableList.Builder<DataSegment> publishedSegmentsBuilder = ImmutableList.builder();
    FileSystem fs = directory.getFileSystem(conf);
      for (FileStatus fileStatus : fs.listStatus(directory)) {
